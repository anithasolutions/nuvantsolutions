    ...
    <CareersContainer>
      ...
      <MainContent>
        <ContentText>
          ...
          <WorkDescription>
          Nuvant Solutions is an IT services and solutions provider company, supporting various businesses across the USA through innovative IT services and solutions. We deliver end-to-end software services to B2B and B2C companies globally that can be customized corresponding to your business requirements. Over the years, Nuvant Solutions has associated with various industries and remains successful in retaining them to this day due to their quality-driven services.
          </WorkDescription>
          <WorkDescription>
          At Nuvant Solutions, our expert team is highly knowledgeable and skilled at resolving your business challenges by analyzing the intensity with a unique approach. We look after everything, right from development to maintenance, digitalizing business operations, testing, handling big data, and providing complete support while ensuring quality and security.
          </WorkDescription>
        </ContentText>
      ...
      <CurrentOpeningsSection>
        ...
        <ContactInstructions>
          Please mail your resumes to <EmailLink>hr@nuvantsolutions.com</EmailLink> with the subject line having the role name
        </ContactInstructions>
