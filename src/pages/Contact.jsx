  ...
  const contactOptions = [
    {
      ...
      description: "Please mail your issues to info@nuvantsolutions.com"
    },
    {
      icon: contact2,
      title: "Submit Resume",
      description: "Please mail your resumes to hr@nuvantsolutions.com with the subject line having the role name"
    },
    {
      icon: contact3,
      title: "Send an Email",
      description: "Please mail your queries to info@nuvantsolutions.com with the subject line having the query"
    }
  ];
