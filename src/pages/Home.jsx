...
const Home = () => {
  ...
  return (
    <>
      <HeroSection>
        <ContentWrapper>
          <WelcomeText>Welcome to Nuvant Solutions.</WelcomeText>
      ...
      <AboutContainer>
        <AboutSection>
          <AboutContent>
            <AboutHeading>About Nuvant Solutions</AboutHeading>
            <AboutText>
              Nuvant Solutions is a technology consulting and support company dedicated to helping 
            ...
            <AboutText>
              Nuvant Solutions has been a leading provider of Software services and solutions dedicated 
          ...
          <AboutImage src={homeImage1} alt="About Nuvant Solutions" />
        </AboutSection>
      </AboutContainer>
      ...
      <AboutContainer>
        <AboutSection>
          <AboutContent>
            ...
            <AboutText>
            We deliver end-to-end software services to B2B and B2C companies globally that can be customized corresponding to your business requirements. Over the years, NuvantSolutions has associated with various industries and remains successful in retaining them to this day due to their quality-driven services.
            </AboutText>
            <WhyUsButton to="/careers">
              <ButtonText>Learn More →</ButtonText>
            </WhyUsButton>
          </AboutContent>
          <AboutImage src={homeImage2} alt="Careers at Nuvant Solutions" />
        </AboutSection>
      </AboutContainer>
    </>
  );
